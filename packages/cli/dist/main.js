...
var require_types = __commonJS({
  "../core/dist/types.js"(exports2) {
    ...
    exports2.matchKey = matchKey;
    exports2.matchPositionsEqual = matchPositionsEqual;
    exports2.scopeLabel = scopeLabel;
...
var require_search = __commonJS({
  "../core/dist/search.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.searchInSpans = searchInSpans;
    exports2.replaceSingleMatch = replaceSingleMatch;
    exports2.replaceInSpans = replaceInSpans;
    ...
    function searchInSpans(path2, fileText, spans, options) {
...
var require_binary = __commonJS({
  "../core/dist/binary.js"(exports2) {
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.isLikelyBinaryPath = isLikelyBinaryPath;
...
var require_files = __commonJS({
  "../core/dist/files.js"(exports2) {
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.parseExtensionManifest = parseExtensionManifest;
    exports2.loadExtensionManifests = loadExtensionManifests;
    exports2.loadAllExtensionManifests = loadAllExtensionManifests2;
    exports2.buildGrammarMap = buildGrammarMap;
    exports2.buildGrammarBundle = buildGrammarBundle2;
    exports2.readDefaultExcludes = readDefaultExcludes;
    ...
    exports2.mergeExcludeSources = mergeExcludeSources;
    ...
    function parseExtensionManifest(extensionPath, pkg) {
      ...
      for (const lang of pkg.contributes?.languages ?? []) {
        ...
        if (lang.configuration) {
          (0, language_config_1.mergeCommentRules)(commentRules, lang.id, (0, language_config_1.parseLanguageConfiguration)(path2.join(extensionPath, lang.configuration)));
        }
      }
      for (const g of pkg.contributes?.grammars ?? []) {
        const scope = {
          scopeName: g.scopeName,
          grammarPath: path2.join(extensionPath, g.path),
          extensionPath,
    ...
    function loadExtensionManifests(extensionsDir) {
      ...
      for (const entry of fs3.readdirSync(extensionsDir, { withFileTypes: true })) {
        ...
        const extensionPath = path2.join(extensionsDir, entry.name);
        const pkgPath = path2.join(extensionPath, "package.json");
    ...
    function loadAllExtensionManifests2(dirs) {
    ...
    async function resolveFilesNode2(options) {
      ...
      const defaultExcludes = options.defaultExcludes ?? (options.useDefaultExcludes !== false ? readDefaultExcludes(options.settingsPath ?? path2.join(cwd, ".vscode", "settings.json")) : []);
      ...
      for (const root of searchRoots) {
        const absRoot = path2.resolve(cwd, root);
        ...
        for (const file of entries) {
          ...
          const rel = path2.relative(cwd, file).replace(/\\/g, "/");
...
var require_scopediscovery = __commonJS({
  "../core/dist/scopediscovery.js"(exports2) {
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.discoverScopes = discoverScopes;
...
var require_paths = __commonJS({
  "../core/dist/paths.js"(exports2) {
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.findModuleRoot = findModuleRoot;
    ...
    function findModuleRoot(startDir) {
      ...
      const vendor = path2.join(dir, "vendor");
    ...
    function resolveFromModuleRoot(moduleRoot, pkgPath) {
      if (moduleRoot) {
        const candidate = path2.join(moduleRoot, pkgPath);
    ...
    function treeSitterWasmsDir(moduleRoot) {
      if (moduleRoot) {
        const candidate = path2.join(moduleRoot, "tree-sitter-wasms");
        if (fs3.existsSync(candidate)) {
          return candidate;
        }
      }
      return path2.dirname(require.resolve("tree-sitter-wasms/package.json"));
    }
  }
});
...
`;
    ...
    var TreeSitterBackend = class {
      ...
      async getParser(languageId) {
        ...
        const wasmPath = path2.join(this.wasmDir, "out", wasmFile);
...
function parseArgs(argv) {
  const args2 = {
    scope: import_core.DEFAULT_SCOPE,
    isRegex: false,
  ...
  for (let i2 = 0; i2 < argv.length; i2++) {
    ...
    switch (a) {
      ...
      case "--scope":
      case "-s":
        args2.scope = argv[++i2] ?? import_core.DEFAULT_SCOPE;
        break;
      case "--include":
        args2.include = argv[++i2];
        break;
      case "--exclude":
        args2.exclude = argv[++i2];
        break;
      case "--regex":
      case "-r":
        args2.isRegex = true;
      ...
      case "--case":
      case "-i":
        args2.isCaseSensitive = true;
        break;
      case "--word":
      case "-w":
        args2.matchWholeWord = true;
        break;
      case "--ext-dir":
        args2.extDir = argv[++i2];
        break;
      case "--help":
      case "-h":
        usage();
...
async function main() {
  ...
  const options = {
    pattern: args2.query,
    isRegex: args2.isRegex,
    isCaseSensitive: args2.isCaseSensitive,
    matchWholeWord: args2.matchWholeWord,
    scopeId: args2.scope
  };
  if (options.isRegex) {
    const err2 = (0, import_core.validateRegex)(options.pattern);
    if (err2) {
      console.error(err2);
      process.exit(1);
    }
  ...
  const extDirs = args2.extDir ? [args2.extDir] : [
    path.join(os.homedir(), ".vscode", "extensions"),
    path.join(os.homedir(), ".cursor", "extensions")
  ];
  const manifests = (0, import_core.loadAllExtensionManifests)(extDirs);
  const grammarBundle = (0, import_core.buildGrammarBundle)(manifests);
  const extractor = new import_core.SpanExtractor(grammarBundle.primaryGrammars, {
    preferTreeSitter: true,
    commentRules: grammarBundle.commentRules,
    grammarsByScope: grammarBundle.grammarsByScope
  });
  const files = await (0, import_core.resolveFilesNode)({
    cwd,
    paths: args2.paths.length ? args2.paths : ["."],
    include: args2.include,
  ...
  const results = await (0, import_core.runScopedSearch)(extractor, inputs, options);
