...
var replace_history_core_exports = {};
__export(replace_history_core_exports, {
  applyReversePatch: () => applyReversePatch,
  contentHash: () => contentHash,
  createReversePatch: () => createReversePatch,
  sanitizeFileId: () => sanitizeFileId
});
module.exports = __toCommonJS(replace_history_core_exports);
